...
module ProjectivePlane.Harmonic.Uniqueness.MBase {a b c d e}
  ...
  where
   ...
   module   Case₁ 
      ...
      where 
       ...
       open Case₀ D♯D' C♯A C♯B l♯l' public

       module Case₁-R'∉RB
              (R'∉RB : R' ∉ join R♯B) where
              ...
              module PerspectivePQR 
                     ...
                     perspectiveAxis-PQR : ArePerspectiveAxis tPQR t'PQR
                     perspectiveAxis-PQR 
                       = toPerspectiveAxis record
                       { axis = join A♯B
                       ; areDistinct 
                     ...
                     perspectiveCenter-PQR = desargues← _ _  perspectiveAxis-PQR
              ...
              module PerspectivePQS
                          ...
                          perspectiveAxis-PQS : ArePerspectiveAxis tPQS t'PQS
                          perspectiveAxis-PQS 
                            = toPerspectiveAxis 
                              (record
                                { axis = join A♯B
                          ...
                          perspectiveCenter-PQS = desargues← _ _  perspectiveAxis-PQS
